...
class Market1501s(BaseImageDataset):
    """
    Market1501
    Reference:
    ...
    dataset_dir = 'Market-1501-v15.09.15-S'
    dataset_dir_syn = 'SyntheImgs/mark2duke-results-s'

    def __init__(self, root="./datasets", verbose=True, for_merge=False, use_syn_pose=False, use_syn_cam=False, **kwargs):
        super(Market1501s, self).__init__()
    ...
    def _process_dir(self, dir_path, relabel=False, use_syn_pose=False, use_syn_cam=False):
        ...
        if relabel: img_paths = img_paths
        pid_container = set()
